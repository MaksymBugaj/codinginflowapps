...
public class NoteAdapter extends android.support.v7.recyclerview.extensions.ListAdapter<Note,NoteAdapter.NoteHolder> {
  private OnItemClickListener listener;
    ...
    public void onBindViewHolder(@NonNull NoteHolder noteHolder, int i) {
        ...
        noteHolder.noteDate.setText(currentNote.getDate());
    }
    ...
    class NoteHolder extends RecyclerView.ViewHolder {
        ...
        public NoteHolder(@NonNull View itemView) {
            ...
            noteDate = itemView.findViewById(R.id.text_view_date);
