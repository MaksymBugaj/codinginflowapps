...
import com.example.maksy.codinginflowapps.MainActivity;
import com.example.maksy.codinginflowapps.R;

import java.util.Date;
import java.util.List;

import static com.example.maksy.codinginflowapps.mvvmNote.AddEditNoteActivity.EXTRA_DATE;
...
public class MVVMActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == RESULT_OK) {
            ...
            String desc = data.getStringExtra(AddEditNoteActivity.EXTRA_DESCRITPION);
