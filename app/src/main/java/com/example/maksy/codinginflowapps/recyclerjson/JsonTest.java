...
public class JsonTest extends AppCompatActivity implements ExampleAdapter.OnItemClickListener {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    mEampleAdapter = new ExampleAdapter(JsonTest.this,mExampleList);
                    mRecyclerView.setAdapter(mEampleAdapter);
                    mEampleAdapter.setOnItemClickListener(JsonTest.this);
